...
public class LiveEncodeActivity extends AppCompatActivity implements SurfaceHolder.Callback {

    private final String TAG = LiveEncodeActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_encode);
        ...
        encodeManager.setEncodeListener(new EncodeManager.EncodeListener() {
            ...
            public void onStart() {
                ...
                fabButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(LiveEncodeActivity.this, R.color.colorAccent)));
            ...
            public void onStop() {
                ...
                isEof = true;
                timeCounter.setTextColor(ContextCompat.getColor(LiveEncodeActivity.this, R.color.colorPrimary));
                timeCounter.stop();
                fabButton.setImageResource(R.drawable.ic_play);
                fabButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(LiveEncodeActivity.this, R.color.colorPrimary)));
            }

            @Override
            public void onFinish() {
                Log.d(TAG, "onStart: listener finished");
                Toast.makeText(LiveEncodeActivity.this, "Write finished", Toast.LENGTH_SHORT).show();
            }
        });
